...
export const SoloIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l-3 3m0 0l3 3m-3-3h5.5a2.5 2.5 0 012.5 2.5v1a2.5 2.5 0 01-2.5 2.5H12m-6 4h5.5a2.5 2.5 0 002.5-2.5v-1a2.5 2.5 0 00-2.5-2.5H6.5" />
  </svg>
);
